...
/**
 * Inline offer detail view rendered inside the main bottom sheet.
 * Replaces the list content when an offer is selected, with a back button
 * to return to the offer list.
 */
const OfferDetailView: React.FC<OfferDetailViewProps> = ({
  ...
  return (
    <>
      ...
      <Pressable
        onPress={onBack}
        className="flex-row items-center gap-1 px-4 pb-2 pt-1"
      >
        <ArrowLeft size={18} className="text-primary" />
        <Text className="text-sm font-medium text-primary">Offers</Text>
      </Pressable>
